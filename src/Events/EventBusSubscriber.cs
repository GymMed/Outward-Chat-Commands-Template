...
{
    //in order to work it needs to be called from active code parts like OutwardChatCommandsTemplate.Awake
    public static class EventBusSubscriber
    {
        ...
        public static void AddedChatCommand(EventPayload payload)
        {
            ...
            OCCT.LogMessage($"Added command {nameParameter.key}");
        }
        ...
        public static void RemovedChatCommand(EventPayload payload)
        {
            ...
            OCCT.LogMessage($"Removed command {nameParameter.key}");
        }
    }
}
