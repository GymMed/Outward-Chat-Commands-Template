...
using OutwardChatCommandsTemplate.Events;
...
namespace OutwardChatCommandsTemplate
{
    ...
    public class OCCT : BaseUnityPlugin
    {
        // Choose a GUID for your project. Change "myname" and "mymodpack".
        public const string GUID = "gymmed.chat_commands_template";
        // Choose a NAME for your project, generally the same as your Assembly Name.
        public const string NAME = "Chat Commands Template";
        // Increment the VERSION when you release a new version of your mod.
        public const string VERSION = "0.0.1";

        // Choose prefix for log messages for quicker search and readablity
        public static string prefix = "[Chat-Commands-Template]";
        ...
        {
            Log.LogMessage($"{OCCT.prefix} {message}");
        }
